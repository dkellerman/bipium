...
export declare function createMetronome(mOpts: Partial<MetronomeOptions>, clickerOpts?: Omit<Partial<ClickerOptions>, 'audioContext'>, audioContext?: AudioContext): Metronome;
