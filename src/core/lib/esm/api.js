...
import { z } from 'zod';
import { DRUM_LOOP_LANES, } from './types';
...
export function createEmptyDrumLoopPattern(timing) {
...
export function seedDrumLoopPattern(timing) {
...
export function remapDrumLoopPattern(pattern, fromTiming, toTiming) {
...
export function resolveDrumLoopSounds(click, pattern, sounds) {
...
export function createSchemas(knownSoundPacks) {
    const configBase = z
        .object({
...
export function mergeConfig(base, patchInput, schemas) {
...
export function validateConfig(base, input, schemas) {
    try {
        return {
            ok: true,
...
export function fromQuery(base, query, schemas) {
...
export function toQuery(config) {
    const params = {
...
export function createRuntimeApi(controls) {
...
export function installWindowBpm(runtime, target = globalThis) {
